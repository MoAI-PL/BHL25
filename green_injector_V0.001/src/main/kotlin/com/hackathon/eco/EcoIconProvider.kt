...
object EcoIconProvider {
    ...
    fun getGrayIcon(): Icon {
        return createLeafIcon(JBColor.GRAY)
    }
    ...
    /**
     * Create a leaf-shaped icon with the given color.
     */
    private fun createLeafIcon(color: Color): Icon {
        ...
        // Draw leaf shape
        val leaf = createLeafShape(ICON_SIZE)
        
        // Fill with gradient
        val gradient = GradientPaint(
            0f, 0f, color.brighter(),
            ICON_SIZE.toFloat(), ICON_SIZE.toFloat(), color.darker()
        )
        g2d.paint = gradient
        g2d.fill(leaf)
        ...
        g2d.drawLine(ICON_SIZE / 2, ICON_SIZE - 2, ICON_SIZE / 2, 3)
